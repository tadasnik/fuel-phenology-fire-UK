...
hue_order = ['Dormant', 'Increase_early', 'Increase_late', 'Maximum', 'Decrease_early', 'Decrease_late']
x_labels = ['Dormant', 'Early \n green-up', 'Late \ngreen-up', 'Maximum', 'Early \nsenescence', 'Late\nsenescence']
    ...
    for nr_col, ax_col in enumerate(ax_row):
        ...
        for nr, phase in enumerate(hue_order):
            ...
            if phase == "Dormant":
                ...
                duration = int(sub[date_cols[nr]].median() - sub[date_cols[nr - 1]].median())
